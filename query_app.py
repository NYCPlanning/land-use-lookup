...
def _(
    ...
    by_district_result = (
        get_naics_indexes_by_district(
            uses_by_zoning_district_minimal, selected_district, naics_codes
        )
    ...
    by_use_name_result = (
        (
            get_district_uses_by_zr_use(
                uses_by_zoning_district_minimal, selected_use_name
            )
            if tab_use_type.value == "Zoning Resolution"
            else get_district_uses_by_naics_index(
                uses_by_zoning_district_minimal, naics_codes, selected_use_name
            )
        )
